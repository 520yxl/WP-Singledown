...
if ($singledown_baidu) {
    $singledown_downtitle='百度网盘';
}
if ($singledown_baidukey) {
    $singledown_downkey .='<strong><h2 style="color:red">提取码：</strong>'.$singledown_baidukey.'</h2></br>';
}
...
<link rel='stylesheet'   href='<?php echo home_url();?>/wp-content/plugins/singledown/css/download.css' type='text/css' media='all' />
...
<div class="singledown-focus" id="focus">
    ...
    <div class="singledown-header">
        ...
        <h2><a style="color:#999" href="<?php echo get_permalink( $id );?>">文章：<?php echo $title;?></a></h2>
        <div class="singledown-buy" style="margin-top:15px">
    <?php if($singledown_baidu){?>
    <a class="singledown-button" href="<?php echo $singledown_baidu;?>"><?php echo $singledown_downtitle;?></a>
          <?php }?>      
        </div>
...
<footer class="footer">
    <div class="container">
    <p>&copy; 2015 <a href="<?php echo home_url();?>"><?php echo get_bloginfo("name");?></a> &nbsp; <a href='http://www.bcsn.net/sitemap.html'>网站地图</a>&nbsp; Copyright by <a href='http://www.bcsn.net'>白菜少年</a></p>
  </div>
</footer>
</body>
</html>