...
if ($singledown_tianyi) {
    $singledown_downtitle='天翼云盘';
    $singledown_downurl=$singledown_tianyi;
}
if ($singledown_tianyikey) {
    $singledown_downkey .='<strong><h2 style="color:red">提取码：</strong>'.$singledown_tianyikey.'</h2></br>';
}
?>
